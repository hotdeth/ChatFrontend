        ...
        >
          ...
          <div class="px-5 pb-5">
            ...
            <Button
              ...
              class="mt-5 w-full">Chat Request</Button
            >
          </div>
        </Card>
      {/each}
...
<Modal bind:open={openChatRequest} title="Send Chat Request" size="md">
  <form action="?/follow" method="POST" use:enhance class="space-y-5">
    <!-- Message -->
    <div>
      <Label
        for="message"
    ...
    >
      ...
      <Button type="submit" color="blue" class="w-full sm:w-auto">
        Send Request
      </Button>
    </div>
  </form>
